package com.example.stm32update.adapter;
...
import com.example.stm32update.R;
...
public class LeDeviceListAdapter extends BaseAdapter {
    ...
    public LeDeviceListAdapter(Context context) {
        ...
        mInflator =(LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE); //-----------取LayoutInflater对象----------
    }
